<?PHP 
  ...
  if($action == "doLogin") {
    ...
    openDB();
    $query =
      "SELECT lpa_client_ID, lpa_client_username, lpa_client_password,lpa_client_status
      FROM lpa_clients
      WHERE lpa_client_username = '$uName'
...
?>
  <div id="contentLogin">
    <form name="frmLogin" id="frmLogin" method="post" action="CustomerLogin.php">
	 ...
	 <div>
		<form>
			<input type="button" value="Click Here to Register" id="btnRegRec" onclick="" />
		</form> 
	</div>
 </div>
